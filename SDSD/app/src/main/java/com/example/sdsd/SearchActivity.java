...
public class SearchActivity extends AppCompatActivity {
    ...
    private void fillSearchList(){
        ...
        searchList.add(new SearchItem("계란"));
        searchList.add(new SearchItem("가스용기"));
        searchList.add(new SearchItem("신문지"));
        searchList.add(new SearchItem("우유팩"));
        searchList.add(new SearchItem("유리병"));
        searchList.add(new SearchItem("형광등"));
    }
